...
function App() {
  ...
  return (
    <>
      ...
      <div className="p_centerPart flex flex-col rounded-[15px] bg-white/10 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-100/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 w-[300px]">
      {/* h-[550px] */}
