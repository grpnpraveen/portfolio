...
function About()
{
    ...
    return(
       ...
       <div className="flex flex-col mt-16 pl-20 text-xl text-[#cecac3]">
        ...
        >
          ...
          <div className="text-left w-[60%]">
            Hi, I'm <span className=" text-orange-500">Ravi Praveen Gali</span> (He/Him/His), Master's graduate in Computer Science at Stony Brook University, NY. My journey in the tech world is driven by a deep passion for programming. 
            <br></br>
            <br></br>
      ...
      {/* <br></br> */}
       As I continued my academic journey at Stony Brook University, I look forward to further deepening my knowledge in computer science. I am excited about the opportunities to collaborate with brilliant minds and contribute to cutting-edge research in the field.
      </div>
