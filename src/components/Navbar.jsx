...
function Navbar(props)
{
    ...
    return (
        ...
        <div className='nav'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className={`size-8 mt-1 fill-current ${props.home_color}`}>
            ...
            <Link to="/portfolio/" className={`${props.home_color} wavy transition-all duration-700 ease-in-out hover:tracking-widest`} id='text_wave'>
                Home
            </Link>
            </div>
